  ...
  class CanBusData : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_engine_rpm.base >> (8 * 3)) & 0xFF;
      ...
      u_gps_latitude.real = this->gps_latitude;
      *(outbuffer + offset + 0) = (u_gps_latitude.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_gps_latitude.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_gps_latitude.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_gps_latitude.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_gps_latitude.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_gps_latitude.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_gps_latitude.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_gps_latitude.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->gps_latitude);
      union {
        double real;
        uint64_t base;
      } u_gps_longitude;
      u_gps_longitude.real = this->gps_longitude;
      *(outbuffer + offset + 0) = (u_gps_longitude.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_gps_longitude.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_gps_longitude.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_gps_longitude.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_gps_longitude.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_gps_longitude.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_gps_longitude.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_gps_longitude.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->gps_longitude);
      union {
        double real;
        uint64_t base;
      } u_gps_altitude;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_gps_latitude.base = 0;
      u_gps_latitude.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_gps_latitude.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_gps_latitude.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_gps_latitude.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_gps_latitude.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_gps_latitude.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_gps_latitude.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_gps_latitude.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->gps_latitude = u_gps_latitude.real;
      offset += sizeof(this->gps_latitude);
      union {
        double real;
        uint64_t base;
      } u_gps_longitude;
      u_gps_longitude.base = 0;
      u_gps_longitude.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_gps_longitude.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_gps_longitude.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_gps_longitude.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_gps_longitude.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_gps_longitude.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_gps_longitude.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_gps_longitude.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->gps_longitude = u_gps_longitude.real;
      offset += sizeof(this->gps_longitude);
      union {
        double real;
        uint64_t base;
