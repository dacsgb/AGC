...
namespace lgsvl_msgs
{
  ...
  class DetectedRadarObject : public ros::Msg
  {
    public:
      ...
      typedef double _sensor_angle_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (u_id.base >> (8 * 3)) & 0xFF;
      ...
      u_sensor_angle.real = this->sensor_angle;
      *(outbuffer + offset + 0) = (u_sensor_angle.base >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (u_sensor_angle.base >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (u_sensor_angle.base >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (u_sensor_angle.base >> (8 * 3)) & 0xFF;
      *(outbuffer + offset + 4) = (u_sensor_angle.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_sensor_angle.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_sensor_angle.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_sensor_angle.base >> (8 * 7)) & 0xFF;
      offset += sizeof(this->sensor_angle);
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_sensor_angle.base = 0;
      u_sensor_angle.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_sensor_angle.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_sensor_angle.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_sensor_angle.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_sensor_angle.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_sensor_angle.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_sensor_angle.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_sensor_angle.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
      this->sensor_angle = u_sensor_angle.real;
      offset += sizeof(this->sensor_angle);
