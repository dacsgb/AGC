...
namespace vector_map_msgs
{
  ...
  class Lane : public ros::Msg
  {
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 4) = (u_span.base >> (8 * 4)) & 0xFF;
      *(outbuffer + offset + 5) = (u_span.base >> (8 * 5)) & 0xFF;
      *(outbuffer + offset + 6) = (u_span.base >> (8 * 6)) & 0xFF;
      *(outbuffer + offset + 7) = (u_span.base >> (8 * 7)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_span.base = 0;
      u_span.base |= ((uint64_t) (*(inbuffer + offset + 0))) << (8 * 0);
      u_span.base |= ((uint64_t) (*(inbuffer + offset + 1))) << (8 * 1);
      u_span.base |= ((uint64_t) (*(inbuffer + offset + 2))) << (8 * 2);
      u_span.base |= ((uint64_t) (*(inbuffer + offset + 3))) << (8 * 3);
      u_span.base |= ((uint64_t) (*(inbuffer + offset + 4))) << (8 * 4);
      u_span.base |= ((uint64_t) (*(inbuffer + offset + 5))) << (8 * 5);
      u_span.base |= ((uint64_t) (*(inbuffer + offset + 6))) << (8 * 6);
      u_span.base |= ((uint64_t) (*(inbuffer + offset + 7))) << (8 * 7);
