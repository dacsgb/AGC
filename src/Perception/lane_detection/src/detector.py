...
class Detector():
    def __init__(self,camera):
        ...
        self.err = StampedFloat()

        #cccae4
        #5f309b

        white= [[0,0,200],[255,55,255]]
        yellow = [[22,93,0],[45,255,255]]
        purple = [[110,100,50],[193,242,183]]
        self.colorMasks = np.array([purple])
    ...
    def publishErr(self,err):
        msg = StampedFloat()
        msg.data = err
        msg.time = rospy.get_rostime().now()
...
if __name__ == "__main__":
    ...
    camera = rospy.get_param("~camera", default="pointgrey_center")
