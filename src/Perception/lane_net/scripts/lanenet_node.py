...
from lane_net.msg import Lane_Image
...
class lanenet_detector():
    def __init__(self):
        self.image_topic = rospy.get_param('~image_topic',"/usb_camera/original")
        self.output_image = rospy.get_param('~output_image',"/lane_images")
        self.output_lane = rospy.get_param('~output_lane',"/Lane")
        self.weight_path = rospy.get_param('~weight_path',"/home/pathplanning/Code/AGC/src/Perception/lane_net/model/tusimple_lanenet/tusimple_lanenet.ckpt")
        self.use_gpu = rospy.get_param('~use_gpu',0)
        self.lane_image_topic = rospy.get_param('~lane_image_topic',"/lane_image")
