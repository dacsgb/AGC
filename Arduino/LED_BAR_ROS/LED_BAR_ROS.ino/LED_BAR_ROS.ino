...
//Heartbeat config
#definte INTERRUPT_0 2
long safetytimeout = 17000;
...
void setup(void)
{
  ...
  Serial.begin(57600);
  createHeartbeatInterrupt(INTERRUPT_0, safetyTimeout )
}
...
int y=4;
dmd.selectFont(SystemFont5x7);
dmd.drawString( x,y, "HEART", 5, GRAPHICS_NORMAL );
dmd.drawString( x+j,y, "BEAT", 5, GRAPHICS_NORMAL );
}
